...
Creates concordance for all the words in the given Bible.
...
If you download a bible-concordance-creator.jar file, you will need a Java Runtime Environment 8 or above, available from [https://www.oracle.com/in/java/technologies/downloads/](https://www.oracle.com/in/java/technologies/downloads/).

Just run

~~~
java -jar bible-concordance-creator.jar
~~~

on the command line for usage information.

# Steps to use bible-concordance-creator.jar
...
- Example 1: java -jar bible-concordance-creator.jar TextFiles C:/taOV.ont C:/taOV-information.ini
- Example 2: java -jar bible-concordance-creator.jar TextFilesByDirectory C:/taOV.ont C:/taOV-information.ini
